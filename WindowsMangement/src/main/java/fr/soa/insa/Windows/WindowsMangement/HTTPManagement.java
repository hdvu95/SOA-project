...
public class HTTPManagement {
	...
	public static int sendPOST(String address, String value) throws IOException {
		...
		// For POST body - START
		String body = "<m2m:cin xmlns:m2m='http://www.onem2m.org/xml/protocols'><cnf>"+getDate()+"</cnf><con>"+value+"</con></m2m:cin>";
	...
	public static String extractAns(String ans){
		...
		if(ans.equals("-1")){
			return "[ERROR] Content extraction went wrong";
		}
		rep = tmp[1];
	...
	public static String extractTime(String ans){
		String rep = "-1";
